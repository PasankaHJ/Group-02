...
<head>
    ...
    <script src="../sources/js/navbar.js"></script>
</head>
...
<body>
    ...
    <header>
        <section>
            ...
            <span><a href="mailto:solutions.yourpc.support@gmail.com"><i class="fa fa-envelope" style="color: #F7941E;"></i> solutions.yourpc.support@gmail.com </a></span>
            <span><a href="tel:077-116-6461"><i class="fa fa-phone" style="color: #F7941E;"></i> +(94)-77-116-6461</a></span>
        </section>
        <section></section>
        <?php if (isset($_SESSION["sid"])) {
        ?>
            <section>
                <span><a href="account.php?id=<?php echo $_SESSION["sid"]; ?>"><i class="fa fa-lock" style="color: #F7941E;"></i> <?php echo $_SESSION["sname"]; ?> </a></span>
