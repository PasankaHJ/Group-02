        ...
        <div class="display_area">
            <div class="row">
                <div class="column" style="width: 360px;">
                    <div class="row">
                        <img src="../images/uploads/parts/<?php echo $row["image"]; ?>" alt="" style="height: 350px; width: 350px;">
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="margin-top: 50px;">
                     <div id = "request_btn">
                        <button class="btnrequest" onclick="sendRequest(<?php echo $part_id; ?>)">Request &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-check-square-o" style="color: white;"></i></button>
