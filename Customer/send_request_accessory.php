...
$rrr = mysqli_fetch_array($resres);
    ...
    try {
        ...
        $to      = $mail;
        $subject = 'New request For an Accessory';
        $message = 'Dear '.$sel_name.', Mr/Mrs '.$cus_fname.' '.$cus_lname.' is asking for a Computer Accessory.( Accessory name = '.$title.') from your shop. Contact the customer( email address = '.$cus_mail.' / Telephone = '.$cus_mobile.' ) to keep the business going. Thank you.... Have a nice Day.';
