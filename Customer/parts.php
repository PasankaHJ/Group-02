		...
		<div class="container-fluid">
			<div class="carousel-inner">
				<div class="carousel-item filter active">
      				<img class="d-block w-100" src="images/parts_page.jpg" alt="First slide" style="height: 500px; width: 100%;">
	...
	<br><br>
		...
		<div class="container" style="margin-bottom: -1000px;">
				<div class="row" style="width: 95%; border: 5px solid #014B70; border-radius: 10px; color: #014B70; height: 60px;">
					<h1 style="margin-left: 60px;">All Parts</h1>
				</div>
...
<script>
	...
	function fetchAllParts() {
		var action = "fetch_parts";

		$.ajax ({
			url: 'fetch_all_parts.php',
        method: "POST",
        data: {
          action: action
