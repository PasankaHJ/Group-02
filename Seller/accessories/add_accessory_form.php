...
<?php include "navbar.php"; ?>
    <div class="container-fluid">
        ...
        <div class="login" style="margin-top: 30px;">
            ...
            <form method="post" action="add_accessory.php">
                <label class="info">
                ...
                <label class="info">
                    <select name="category" class="select_list" required>
                    <option disabled="disabled" selected=""> --- Select Category --- </option>

                        <?php
                        $getCategory = "SELECT * FROM accesories_types";
                        $result = mysqli_query($conn, $getCategory);
